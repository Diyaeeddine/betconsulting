...
interface Progression {
    ...
    progress: string | null; // Chemin du fichier
...
export default function Progressions({ progressions, projets, users }: Props) {
    ...
    const { data, setData, post, processing, errors, reset } = useForm({
        ...
        progress_file: null as File | null,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        formData.append('description_progress', data.description_progress);
        ...
        if (selectedFile) {
            formData.append('progress_file', selectedFile);
        }
