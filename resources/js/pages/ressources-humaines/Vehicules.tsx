...
import { Car, DollarSign, Edit, Eye, Plus, Trash2, User } from 'lucide-react';
...
export default function Vehicules({ vehicules, salaries }: Props) {
    ...
    const getEtatBadge = (etat: string) => {
        ...
        return (
            <span
                className={`rounded-full border px-2 py-1 text-xs font-medium ${etatClasses[etat as keyof typeof etatClasses] || 'border-gray-200 bg-gray-100 text-gray-800'}`}
            >
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-6">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-gray-600">Gérez tous les véhicules de l'entreprise</p>
                    </div>
                    <button
                    ...
                    <div className="rounded-lg border border-gray-100 bg-white p-6 shadow-md">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900">{vehicules.filter((v) => v.etat === 'disponible').length}</p>
                            </div>
                        </div>
                    </div>
                    <div className="rounded-lg border border-gray-100 bg-white p-6 shadow-md">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900">{vehicules.filter((v) => v.etat === 'en_mission').length}</p>
                            </div>
                        </div>
                    </div>
                    <div className="rounded-lg border border-gray-100 bg-white p-6 shadow-md">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900">{vehicules.filter((v) => v.etat === 'en_panne').length}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="overflow-x-auto">
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead className="bg-gray-50">
                                <tr>
                                    <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Véhicule</th>
                                    ...
                                    <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">État</th>
                                    <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Statut</th>
                                    <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">
                                        Salarié Affecté
                                    </th>
                                    <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Coût/Montant</th>
                                    <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Actions</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-gray-200 bg-white">
                                {vehicules.map((vehicule) => (
                                    <tr key={vehicule.id} className="transition-colors hover:bg-gray-50">
                                        ...
                                        <td className="whitespace-nowrap px-6 py-4 font-mono text-sm text-gray-900">{vehicule.matricule}</td>
                                        <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-900">
                                            {TYPES_VEHICULES.find((t) => t.value === vehicule.type)?.label || vehicule.type}
                                        </td>
                                        <td className="whitespace-nowrap px-6 py-4">{getEtatBadge(vehicule.etat)}</td>
                                        <td className="whitespace-nowrap px-6 py-4">{vehicule.statut ? getStatutBadge(vehicule.statut) : '-'}</td>
                                        <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-900">
                ...
                {showModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-600 bg-opacity-50">
                        <div className="m-4 max-h-[90vh] w-full max-w-6xl overflow-y-auto rounded-lg bg-white p-6">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="border-b pb-6">
                                    <h4 className="text-md mb-4 font-medium text-gray-900">Informations de base</h4>
                                    <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                maxLength={255}
                                            />
                                            {errors.marque && <div className="mt-1 text-sm text-red-500">{errors.marque}</div>}
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                maxLength={255}
                                            />
                                            {errors.modele && <div className="mt-1 text-sm text-red-500">{errors.modele}</div>}
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                maxLength={255}
                                            />
                                            {errors.matricule && <div className="mt-1 text-sm text-red-500">{errors.matricule}</div>}
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            {errors.etat && <div className="mt-1 text-sm text-red-500">{errors.etat}</div>}
                                        </div>
                                ...
                                {data.statut === 'achete' && (
                                    <div className="border-b pb-6">
                                        <h4 className="text-md mb-4 font-medium text-gray-900">Informations d'achat</h4>
                                        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                                />
                                                {errors.date_achat && <div className="mt-1 text-sm text-red-500">{errors.date_achat}</div>}
                                            </div>

                                            <div>
                                                <label className="block text-sm font-medium text-gray-700">Montant d'achat (€) *</label>
                                                <input
                                                    type="number"
                                                    step="0.01"
                                                    min="0"
                                                    ...
                                                    required
                                                />
                                                {errors.montant_achat && <div className="mt-1 text-sm text-red-500">{errors.montant_achat}</div>}
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                {errors.type_paiement && <div className="mt-1 text-sm text-red-500">{errors.type_paiement}</div>}
                                            </div>

                                            {data.type_paiement === 'credit' && (
                                                <>
                                                    <div>
                                                        <label className="block text-sm font-medium text-gray-700">Montant crédit total (€)</label>
                                                        <input
                                                            type="number"
                                                            step="0.01"
                                                            min="0"
                                                            ...
                                                            className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                                        />
                                                        {errors.montant_credit_total && (
                                                            <div className="mt-1 text-sm text-red-500">{errors.montant_credit_total}</div>
                                                        )}
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                                        />
                                                        {errors.montant_credit_mensuel && (
                                                            <div className="mt-1 text-sm text-red-500">{errors.montant_credit_mensuel}</div>
                                                        )}
                                                    </div>

                                                    <div>
                                                        <label className="block text-sm font-medium text-gray-700">Durée crédit (mois)</label>
                                                        <input
                                                            type="number"
                                                            min="1"
                                                            ...
                                                            className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                                        />
                                                        {errors.duree_credit_mois && (
                                                            <div className="mt-1 text-sm text-red-500">{errors.duree_credit_mois}</div>
                                                        )}
                                                    </div>

                                                    <div>
                                                        <label className="block text-sm font-medium text-gray-700">Date début crédit</label>
                                                        <input
                                                            type="date"
                                                            ...
                                                            className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                                        />
                                                        {errors.date_debut_credit && (
                                                            <div className="mt-1 text-sm text-red-500">{errors.date_debut_credit}</div>
                                                        )}
                                                    </div>
                                                </>
                                            )}
                                ...
                                {data.statut === 'loue' && (
                                    <div className="border-b pb-6">
                                        <h4 className="text-md mb-4 font-medium text-gray-900">Informations de location</h4>
                                        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                                            <div>
                                                <label className="block text-sm font-medium text-gray-700">Coût location/jour (€)</label>
                                                <input
                                                    type="number"
                                                    step="0.01"
                                                    min="0"
                                                    ...
                                                    className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                                />
                                                {errors.cout_location_jour && (
                                                    <div className="mt-1 text-sm text-red-500">{errors.cout_location_jour}</div>
                                                )}
                                            </div>

                                            <div>
                                                <label className="block text-sm font-medium text-gray-700">Date début location</label>
                                                <input
                                                    type="date"
                                                    ...
                                                    className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                                />
                                                {errors.date_debut_location && (
                                                    <div className="mt-1 text-sm text-red-500">{errors.date_debut_location}</div>
                                                )}
                                            </div>

                                            <div>
                                                <label className="block text-sm font-medium text-gray-700">Date fin location</label>
                                                <input
                                                    type="date"
                                                    ...
                                                    className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                                />
                                                {errors.date_fin_location && (
                                                    <div className="mt-1 text-sm text-red-500">{errors.date_fin_location}</div>
                                                )}
                                            </div>

                                            <div>
                                                <label className="block text-sm font-medium text-gray-700">Coût total location (€)</label>
                                                <input
                                                    type="number"
                                                    step="0.01"
                                                    min="0"
                                                    ...
                                                    className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                                />
                                                {errors.cout_location && <div className="mt-1 text-sm text-red-500">{errors.cout_location}</div>}
                                            </div>

                                            <div>
                                                <label className="block text-sm font-medium text-gray-700">Durée location (jours)</label>
                                                <input
                                                    type="number"
                                                    min="1"
                                                    ...
                                                    className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                                />
                                                {errors.duree_location && <div className="mt-1 text-sm text-red-500">{errors.duree_location}</div>}
                                            </div>
                                        </div>
                                    </div>
                                )}
                                ...
                                {/* Affectation salarié */}
                                <div>
                                    <h4 className="text-md mb-4 font-medium text-gray-900">Affectation salarié</h4>
                                    <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700">Salarié affecté</label>
                                            <select
                                            ...
                                            {errors.salarie_id && <div className="mt-1 text-sm text-red-500">{errors.salarie_id}</div>}
                                        </div>

                                        <div>
                                            <label className="block text-sm font-medium text-gray-700">Date d'affectation</label>
                                            <input
                                                type="date"
                                                ...
                                                className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                            />
                                            {errors.date_affectation && <div className="mt-1 text-sm text-red-500">{errors.date_affectation}</div>}
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            {errors.date_disponibilite && (
                                                <div className="mt-1 text-sm text-red-500">{errors.date_disponibilite}</div>
                                            )}
                                        </div>

                                        <div>
                                            <label className="block text-sm font-medium text-gray-700">Durée d'affectation (jours)</label>
                                            <input
                                                type="number"
                                                min="1"
                                                ...
                                                className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                            />
                                            {errors.duree_affectation && <div className="mt-1 text-sm text-red-500">{errors.duree_affectation}</div>}
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-600 bg-opacity-50">
                        <div className="m-4 w-full max-w-md rounded-lg bg-white p-6">
                            <div className="mb-4 flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-lg font-medium text-gray-900">Supprimer le véhicule</h3>
                            ...
                            <p className="mb-6 text-gray-700">
                                ...
                                <strong>
                                    "{deletingVehicule.marque} {deletingVehicule.modele}"
                                </strong>{' '}
                                (Matricule: {deletingVehicule.matricule}) ?
                            </p>
