            ...
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="p-8">
                            <div className="flex flex-col items-start gap-6 md:flex-row md:items-center md:justify-between">
                                <div className="flex items-center gap-6">
                                    <div className="flex h-24 w-24 items-center justify-center rounded-2xl bg-white/20 backdrop-blur-sm text-3xl font-bold text-white shadow-lg ring-4 ring-white/30">
                                        {initiales}
                                    </div>
                    ...
                    <div className="mb-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        <div className="group relative overflow-hidden rounded-2xl bg-white p-6 shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
                            <div className="absolute top-0 right-0 h-32 w-32 -mr-8 -mt-8 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 opacity-10"></div>
                            <div className="relative">
                                <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-blue-100 text-blue-600 group-hover:scale-110 transition-transform">
                                    <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                                    </svg>
                                </div>
                                <p className="text-sm font-medium text-gray-600 mb-1">Tâches aujourd'hui</p>
                        ...
                        <div className="group relative overflow-hidden rounded-2xl bg-white p-6 shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
                            <div className="absolute top-0 right-0 h-32 w-32 -mr-8 -mt-8 rounded-full bg-gradient-to-br from-green-500 to-green-600 opacity-10"></div>
                            <div className="relative">
                                <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-green-100 text-green-600 group-hover:scale-110 transition-transform">
                                    <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                </div>
                                <p className="text-sm font-medium text-gray-600 mb-1">Tâches terminées</p>
                        ...
                        <div className="group relative overflow-hidden rounded-2xl bg-white p-6 shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
                            <div className="absolute top-0 right-0 h-32 w-32 -mr-8 -mt-8 rounded-full bg-gradient-to-br from-purple-500 to-purple-600 opacity-10"></div>
                            <div className="relative">
                                <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-purple-100 text-purple-600 group-hover:scale-110 transition-transform">
                                    <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="group relative overflow-hidden rounded-2xl bg-white p-6 shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
                            <div className="absolute top-0 right-0 h-32 w-32 -mr-8 -mt-8 rounded-full bg-gradient-to-br from-orange-500 to-orange-600 opacity-10"></div>
                            <div className="relative">
                                <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-orange-100 text-orange-600 group-hover:scale-110 transition-transform">
                                    <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start gap-3 rounded-xl bg-gray-50 p-4 transition-colors hover:bg-gray-100">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="font-medium text-gray-900 truncate">{salarie.email}</p>
                                        </div>
                                    </div>
                                    {salarie.telephone && (
                                        <div className="flex items-start gap-3 rounded-xl bg-gray-50 p-4 transition-colors hover:bg-gray-100">
                            ...
                            <div className="rounded-2xl bg-white p-6 shadow-lg">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="rounded-xl border-2 border-dashed border-gray-200 bg-gray-50 p-4">
                                        <p className="text-xs font-medium text-gray-600 mb-2">Jours de travail</p>
                                ...
                                <div className="p-8">
                                    {activeTab === 'conge' ? (
                                        <form onSubmit={soumettreConge} className="space-y-6">
                                            <div>
                                                <p className="text-sm text-gray-600 mb-6">
                                                    Remplissez ce formulaire pour soumettre une demande de congé. Votre demande sera examinée par votre responsable.
                                                </p>
                                            </div>
                                            ...
                                            <button
                                                ...
                                                className="w-full rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 font-semibold text-white shadow-lg transition-all hover:shadow-xl hover:from-blue-700 hover:to-blue-800 disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:shadow-lg"
                                            >
                                                {processingConge ? (
                                        ...
                                        <form onSubmit={soumettreCertificat} className="space-y-6">
                                            <div>
                                                <p className="text-sm text-gray-600 mb-6">
                                                    Téléchargez votre certificat médical avec les dates concernées. Les formats acceptés sont PDF, JPG et PNG.
                                                </p>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    ...
                                                    >
                                                        {!fichierCertificat ? (
                                                            <>
                                                                <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-gray-200 group-hover:bg-green-100 transition-colors">
                                                            ...
                                                            <>
                                                                ...
                                                                <p className="text-xs font-medium text-gray-600 max-w-xs truncate">
                                            ...
                                            <button
                                                ...
                                                className="w-full rounded-xl bg-gradient-to-r from-green-600 to-green-700 px-6 py-4 font-semibold text-white shadow-lg transition-all hover:shadow-xl hover:from-green-700 hover:to-green-800 disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:shadow-lg"
                                            >
                ...
                {/* Notifications toast */}
                {notification && (
                    <div className="fixed right-4 bottom-4 z-50 animate-slide-in-right">
                        <div
                            className={`min-w-md max-w-md rounded-2xl p-6 shadow-2xl ${
