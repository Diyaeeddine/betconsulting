...
const breadcrumbs = [
    ...
    {
        title: 'Documents complémentaires archivés',
        href: '/documents-complementaires/archives',
    },
];
...
const ArchiveDocumentsComplementaires: React.FC = () => {
                ...
                <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <div className="flex items-center gap-3">
                                    ...
                                    <h1 className="text-3xl font-semibold text-gray-900">Documents complémentaires archivés</h1>
                                </div>
                                <p className="mt-2 text-gray-600">Retrouvez ici vos documents complémentaires archivés (versions précédentes)</p>
                            </div>
                            <button
                                onClick={() => router.visit('/documents-complementaires')}
                            ...
                            >
                                ...
                                Retour aux documents complémentaires
                            </button>
                        </div>
                    </div>
                    ...
                    {archivedDocuments.length === 0 ? (
                        <div className="rounded-lg border border-gray-200 bg-white p-8 text-center">
                            ...
                            <p className="mt-2 text-gray-500">Aucun document complémentaire archivé trouvé</p>
                            <p className="text-sm text-gray-400">Les versions précédentes de vos documents apparaîtront ici après renouvellement</p>
                        </div>
                    ) : (
...
export default ArchiveDocumentsComplementaires;
