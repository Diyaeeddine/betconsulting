...
interface TermineeProps {
    marcheT: MarchePublic[];
}

const breadcrumbs = [
    {
        title: 'Marchés terminés',
        href: '/marches/terminee',
    },
];
...
export default function Terminee({ marcheT }: TermineeProps) {
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="mb-8">
                        <div className="border-l-4 border-green-600 pl-4">
                            <h1 className="text-3xl font-bold text-gray-900">Marchés Publics Terminés</h1>
                            <p className="mt-1 text-gray-600">Historique des appels d'offres finalisés avec succès</p>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0 md:space-x-4">
                            <div className="relative flex-1">
                                ...
                                <input
                                    ...
                                    className="block w-full rounded-md border border-gray-300 bg-white py-2 pr-3 pl-10 leading-5 placeholder-gray-500 focus:border-green-600 focus:placeholder-gray-400 focus:ring-1 focus:ring-green-600 focus:outline-none"
                                    value={searchTerm}
                            ...
                            <div className="flex items-center space-x-4">
                                {searchTerm && (
                                    <button
                                        ...
                                        className="inline-flex items-center rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:ring-2 focus:ring-green-600 focus:outline-none"
                                    >
                                ...
                                <div className="flex items-center gap-2">
                                    <button
                                        ...
                                        className={`rounded p-2 ${viewMode === 'grid' ? 'bg-green-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`rounded p-2 ${viewMode === 'list' ? 'bg-green-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}
                                    >
                                        <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
                                            <path
                                                fillRule="evenodd"
                            ...
                            <div className="text-sm whitespace-nowrap text-gray-500">
                                {filteredMarches.length} marché{filteredMarches.length > 1 ? 's' : ''} terminé
                    ...
                    {filteredMarches.length === 0 ? (
                        <div className="rounded-lg bg-white p-12 text-center shadow-sm">
                            ...
                            <h3 className="mt-4 text-lg font-medium text-gray-900">
                                {searchTerm ? 'Aucun résultat trouvé' : 'Aucun marché terminé'}
                            </h3>
                            <p className="mt-2 text-gray-500">
                                {searchTerm
                                    ? 'Essayez de modifier vos critères de recherche.'
                                    : "Il n'y a aucun marché public terminé pour le moment."}
                            </p>
                        </div>
                    ) : (
                        <>
                            {viewMode === 'grid' ? (
                                <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 xl:grid-cols-3">
                                    {filteredMarches.map((marche: MarchePublic) => (
                                        <div
                                            key={marche.id}
                                            className="relative cursor-pointer rounded-lg border-l-4 border-green-500 bg-white p-6 shadow-sm transition-shadow hover:shadow-md"
                                            onClick={() => openModal(marche)}
                                        >
                                            <div className="mb-2 flex items-center justify-between">
                                                <div className="flex items-center gap-2">
                                                    <span className="text-sm font-semibold text-green-600">{marche.n_reference || 'N/A'}</span>
                                                    {marche.importance && (
                                                        <span
                                            ...
                                            <div className="space-y-2 text-xs text-gray-600">
                                                ...
                                                <div className="flex justify-between">
                                                    ...
                                                    <span className="font-medium">{formatDate(marche.date_decision)}</span>
                                                </div>
                                                <div className="flex justify-between">
                                                    <span>Ville:</span>
                                ...
                                <div className="rounded-lg bg-white shadow-sm">
                                    <div className="border-b border-gray-200 px-6 py-4">
                                        <h2 className="text-lg font-semibold text-gray-900">Liste des Marchés Terminés</h2>
                                                        ...
                                                        >
                                                            <td className="px-4 py-4 whitespace-nowrap">
                                                                <div className="flex items-center">
                                                                    <div
                                                                        className={`text-sm font-medium ${hoveredRow === index ? 'font-bold text-green-600' : 'text-green-600'}`}
                                                                    >
                                                                        {marche.n_reference || '-'}
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <td className="px-4 py-4 whitespace-nowrap">
                                                                <div className="text-sm text-gray-900">{formatDate(marche.date_decision)}</div>
                                                            </td>
                                                            <td className="px-4 py-4 whitespace-nowrap">
                                        ...
                                        <div className="border-t border-gray-200 bg-gray-50 px-6 py-3">
                                            <div className="flex items-center justify-between">
                                                <div className="text-sm text-gray-500">
                                                    Affichage de {filteredMarches.length} marché{filteredMarches.length > 1 ? 's' : ''} terminé
                                                    {filteredMarches.length > 1 ? 's' : ''}
                                                </div>
                                                <div className="text-sm text-gray-500">
                            ...
                            <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-5xl">
                                <div className="bg-white px-6 py-6">
                                    <div className="flex items-center justify-between border-b border-gray-200 pb-4">
                                        <h3 className="text-xl font-bold text-gray-900">Détails du Marché Terminé</h3>
                                        <button
                                            onClick={closeModal}
                                            className="rounded-md bg-white text-gray-400 hover:text-gray-600 focus:ring-2 focus:ring-green-600 focus:outline-none"
                                        >
                                    ...
                                    <div className="mt-6 max-h-96 overflow-y-auto">
                                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div>
                                                    <dt className="text-sm font-medium text-gray-600">Date limite (originale)</dt>
                                                ...
                                                <div>
                                                    <dt className="text-sm font-medium text-gray-600">Date de décision</dt>
                                                    <dd className="mt-1 text-sm font-semibold text-green-600">
                                                        {formatDate(selectedMarche.date_decision)}
                                                    </dd>
                                                </div>
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div>
                                                    <dt className="text-sm font-medium text-gray-600">Décision finale</dt>
                                ...
                                <div className="flex justify-end space-x-3 bg-gray-50 px-6 py-4">
                                    <button
                                        type="button"
                                        className="inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:ring-2 focus:ring-green-600 focus:outline-none"
                                        onClick={closeModal}
                                    >
                                        Fermer
                                    </button>
